...
public class NetworkModule {
    ...
    @Provides @Singleton
    public RestServiceFactory providesRestServiceFactory(Call.Factory callFactory) {
    ...
    static class ConnectionAwareInterceptor implements Interceptor {
        ...
        static {
            ...
            CACHE_ENABLED_HOSTS.put(ReadabilityClient.HOST, RestServiceFactory.CACHE_CONTROL_MAX_AGE_30M);
        }
        private final Context mContext;

        ConnectionAwareInterceptor(Context context) { mContext = context.getApplicationContext(); }
